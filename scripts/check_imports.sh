...
ALLOWLIST_SHARED="package:flutter/|package:dart:|package:shared/|package:shared_preferences/|package:connectivity_plus/|package:mocktail/|package:dio/|package:flutter_dotenv/|package:equatable/"
