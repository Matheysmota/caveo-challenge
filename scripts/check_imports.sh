...
ALLOWED="package:flutter/|package:dart:|package:shared/|package:dori/|package:caveo_challenge/"
...
if [ -n "$VIOLATIONS" ]; then
    ...
    echo "Exceção: Packages na Allowlist (flutter, shared, dori, caveo_challenge)."
